...
class OpenAIClient:
        ...
        for attempt in range(max_attempts):
            try:
                response = self.client.chat.completions.create(
                    model='gpt-4o',  # Consider updating the model if using an updated API: gpt-3.5-turbo
    ...
    def process_ensemble_training(self, demonstation_file_path, user_prompt, scene_prompt, context_description, n=1 ,temperature=0):
        ...
        # TODO: convert the waypoints to eula+quaternion then evaluate


        self.system_prompt = self.load_prompt(demonstation_file_path)
        context_description = "baed on the demonsations above, pick the correct option below and repsond with the letter A,B,C,D,E"
...
if __name__ == "__main__":
    ...
    client.process_ensemble("_demo_data.txt",instruction, scene_objects, context_description,n=5,temperature=0.2)  
