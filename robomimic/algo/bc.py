...
class BC(PolicyAlgo):
    ...
    def _create_networks(self):
        ...
        """
        self.number_of_demos = 200 # number of demos in the hdf5 file
        self.decimal_places = 3
        self.sample_frequency = 1 # sample every X action
        self.run_length = 20 # how many timesteps should an action be executed for
        self.demonstation_data_path = "tmp/square.hdf5"
